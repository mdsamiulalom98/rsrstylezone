...
class ChildcategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $subcat_namespace = Subcategory::where('id', $request->subcategory_id)->select('id', 'namespace', 'subcategoryName')->first();

        // Get the namespace value
        $namespace = $subcat_namespace->namespace;
        
        // Generate the slug from $request->childcategoryName
        $slug = strtolower(Str::slug($request->childcategoryName));
