...
Route::group(['namespace'=>'Frontend', 'middleware' => ['ipcheck','check_refer']], function() {
    ...
    Route::get('best-sale', [FrontendController::class, 'newarrival'])->name('newarrival');
    ...
    Route::get('discount/{slug}', [FrontendController::class, 'discount'])->name('discount');    
    ...
    // cart route
    Route::post('details-cart/store', [ShoppingController::class, 'dcart_store'])->name('dcart.store');
    Route::get('cart/store', [ShoppingController::class, 'cart_store'])->name('cart.store');
    Route::get('show-cart', [ShoppingController::class, 'cart_show'])->name('cart.show');
...
Route::group(['prefix'=>'customer','namespace'=>'Frontend','middleware' => ['customer','ipcheck','check_refer']], function() {
    ...
    Route::get('/compare', [CustomerController::class, 'compare'])->name('customer.compare');
...
Route::group(['namespace'=>'Admin','middleware' => ['auth','lock','check_refer'],'prefix'=>'admin'], function() {
    ...
    Route::get('products/sort', [ProductController::class,'topsalesort'])->name('products.topsalesort');
    Route::post('products/topsale/sort', [ProductController::class,'sort'])->name('topsale.sort');
