...
@section('title',$category->childcategoryName) 
@push('css')
...
<meta name="twitter:site" content="{{$category->childcategoryName}}" />
<meta name="twitter:title" content="{{$category->childcategoryName}}" />
...
<!-- Open Graph data -->
<meta property="og:title" content="{{$category->childcategoryName}}" />
<meta property="og:type" content="product" />
<meta property="og:url" content="{{route('category',$category->slug)}}" />
<meta property="og:image" content="{{asset($category->image)}}" />
<meta property="og:description" content="{{ $category->meta_description}}" />
<meta property="og:site_name" content="{{$category->childcategoryName}}" />
@endpush 
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="breadcrumb_title">
                <h2><span>{{$category->childcategoryName}}</span></h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="category-breadcrumb d-flex align-items-center">
                    ...
                    <span>/</span>
                    <strong>{{ $category->childcategoryName }}</strong>
                </div>
            </div>
            <div class="col-sm-4">
                    ...
                    @foreach($products as $key=>$value)
                        <div class="product_item wist_item wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.5s">
                            <div class="product_item_inner">
                                ...
                                @if($index < 2)
                                <a class="@if($index == 0) default__img @else hover__img @endif product-href-link" href="{{ route('product',$value->slug) }}">
