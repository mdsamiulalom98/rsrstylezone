                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                        ...
                                        @if ($details->pro_video)
                                            <div class="dimage_item">
                                                <div class="item-video">
                                                    <a class="owl-video"
                                                        href="https://www.youtube.com/watch?v={{ $videoID }}"></a>
                                                    @if ($videoID)
                                                        <img class="owl-lazy"
                                    ...
                                    <div
                                        ...
                                        @if ($details->pro_video)
                                            <div class="indicator-item" data-id="{{ $details->images->count() }}"><img
                                                    src="{{ asset('public/frontEnd/images/owl.video.play.png') }}" /></a>
                                            </div>
                                        @endif
                                            ...
                                            <form action="{{ route('dcart.store') }}" method="POST" name="formName">
                                                ...
                                                <div class="row">
                                                                        ...
                                                                        @foreach ($productcolors as $procolor)
                                                                            <div class="selector-item flex-column">
                                                                                <input type="radio"
                                                                                    ...
                                                                                    value="{{ $procolor->color ? $procolor->color->color : '' }}"
                                                                                    name="product_color"
                                                                                    class="selector-item_radio emptyalert" />
                                                                                <label
                                                                                    data-color="{{ $procolor->color ? $procolor->color->colorName : '' }}"
                                                                                ...
                                                                                <h3>{{ $procolor->color ? $procolor->color->colorName : '' }}
                                                                                </h3>
                                                                            </div>
                                                                        @endforeach
                                                                    </div>
                                                    ...
                                                    @if ($productsizes->count() > 0)
                                                        <div class="pro-size" style="width: 100%;">
                                                            <div class="size_inner">
                                                                ...
                                                                <p>Size - <span id="sizeText"
                                                                        data-value="{{ $selectedSize ? $selectedSize->sizeName : '' }}"
                                                                        class="attibute-name"></span></p>
                                                                <div class="size-container">
                                                                    <div class="selector">
                                                                        @foreach ($productsizes as $prosize)
                                                                            <div class="selector-item">
                                                                                <input type="radio"
                                                                                    ...
                                                                                    class="selector-item_radio emptyalert"
                                                                                    required
                                                                                    @if (request()->input('size') == $prosize->size_id) checked @endif />
                                                                                <label for="f-option{{ $prosize->id }}"
                                                                                    class="selector-item_label"
                                                                                    data-value="{{ $prosize->size->sizeName }}">{{ $prosize->size ? $prosize->size->sizeName : '' }}</label>
                                                                            </div>
                                                                        @endforeach
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class=" d-flex single_product col-sm-6">
                                                        <input type="submit" class="btn px-4 add_cart_btn" id="addcartButton"
                                                            onclick="return sendSuccess();" disabled name="add_cart"
                                                            value=" Add To Cart  " />

                                                        <input type="submit" id="submitButton"
                                                            class="btn px-4 order_now_btn order_now_btn_m"
                                                            onclick="return sendSuccess();" disabled name="order_now"
                                                            value="Buy Now " />
                                                    ...
                                                    <div class="col-sm-6">
                                                        <button type="button" class="size_btn" data-bs-toggle="modal"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="size_chart">
                                                                        <img src="{{ asset($details->size_chart) }}"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                ...
                                <div class="col-sm-12">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active potro_font" id="home-tab"
                                                data-bs-toggle="tab" data-bs-target="#home" type="button"
                                                role="tab">Product Description</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link  potro_font" id="review-tab" data-bs-toggle="tab"
                                                data-bs-target="#review" type="button" role="tab">Review</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link  potro_font" id="youtube-tab" data-bs-toggle="tab"
                                                data-bs-target="#youtube" type="button" role="tab">Youtube
                                                Video</button>
                                        </li>
                                    </ul>
                                            ...
                                            <div class="tab-review">
                                                            ...
                                                            @foreach ($productreviews as $key => $review)
                                                                <div class="col-sm-4 col-6">
                                                                    <div class="review-card">
                                                                        ...
                                                                        <p class="review_content">{{ $review->review }}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            @endforeach
                                                ...
                                                @if (Auth::guard('customer')->user())
                                                    ...
                                                    <form action="{{ route('customer.review') }}" id="review-form"
                                                        ...
                                                        <div class="mt-3">
                                                            <button type="submit"
                                                                class="details-review-btn btn btn-success text-white">Submit</button>
                                                        </div>
                                                    </form>
                                                @else
                                                    <a class="details-login-button"
                                                        href="{{ route('customer.login') }}">Your Review </a>
                                                @endif
                                            ...
                                            <div class="tab-youtube">
                                                @if ($details->youtube_link)
                                                    <iframe width="560" height="315"
                                                        src="https://www.youtube.com/embed/{{ $details->youtube_link }}"
                                        ...
                                        @foreach ($products as $key => $value)
                                            <div class="product_item wist_item wow zoomIn" data-wow-duration="1.5s"
                                                ...
                                                <div class="product_item_inner">
                                                    @if ($value->old_price)
                                                        <div class="discount">@php $discount=(((($value->old_price)-($value->new_price))*100) / ($value->old_price)) @endphp
                                                    ...
                                                    <div class="pro_img">
                                                        @foreach ($value->twoimages as $index => $image)
                                                            @if ($index < 2)
                                                                <a @if ($value->twoimages->count() > 1) @if ($index == 0)
                                                    class="default__img product-href-link"
                                                    @else
                                                    class="hover__img product-href-link" @endif
                                                                @else class="product-href-link" @endif
                                                        ...
                                                        <div class="quick_view_btn">
                                                            <button data-id="{{ $value->id }}"
                                                                class="hover-zoom quick_view" title="Wishlist"><i
                                                                    class="fa-solid fa-magnifying-glass"></i></button>
                                                            <button type="button" class="cart_store"
                                                                data-id="{{ $value->id }}"><i
                                                    ...
                                                    <div class="product__size_selling">
                                                        @foreach ($value->prosizes as $sizes)
                                                            <a class="size__item" data-size="{{ $sizes->size_id }}"
                                                                onmouseover="activateSize(this)"
                                                                href="{{ route('product', $value->slug) }}?size={{ $sizes->size_id }}">{{ $sizes->size ? $sizes->size->sizeName : '' }}</a>
                                                        @endforeach
                                                    </div>
                                                    <div class="pro_des">
                                                        <div class="pro_name">
                                                            <a class="product-href-link"
                                                                href="{{ route('product', $value->slug) }}">{{ Str::limit($value->name, 60) }}</a>
                                                        </div>
                                                        <div class="pro_price">
                                                            <p>
                                                                @if ($value->old_price)
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.selector-item_label').on('mouseover', function() {
                ...
                var checkedLabel = $('.selector-item input:checked').siblings('.selector-item_label')
                    .text();
                var defaultValue = checkedLabel || $('#sizeText').data('value');
                $('#sizeText').text(defaultValue);
            });
    ...
    <script>
        $(document).ready(function() {
            ...
            function checkRadioButtons() {
                ...
                $('#addcartButton').prop('disabled', !isChecked);
            }
