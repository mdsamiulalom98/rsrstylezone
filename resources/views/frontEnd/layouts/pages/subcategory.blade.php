...
<meta name="twitter:site" content="{{$category->subcategoryName}}" />
<meta name="twitter:title" content="{{$category->subcategoryName}}" />
...
<!-- Open Graph data -->
<meta property="og:title" content="{{$category->subcategoryName}}" />
    ...
    <div class="container">
        <div class="row">
            <div class="breadcrumb_title">
                <h2><span>{{$category->subcategoryName}}</span></h2>
            </div>
        </div>
    </div>
</div>
