        ...
        <div class="row">
            <div class="col-sm-12">
                 @php
                    ...
                    $videoId = '';
                    if (preg_match('/(?:youtu\.be\/|youtube\.com\/(?:watch\?v=|embed\/|v\/|shorts\/|live\/))([\w-]+)/', $category->categroy_video, $matches)) {
                        $videoId = $matches[1];
                    }
                @endphp
                        ...
                        <div class="product_item wist_item wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.5s">
                            <div class="product_item_inner">
                                ...
                                <div class="product-image-desc">
                                    <div class="pro_des">
                                        <div class="product__size sort_single third-single four-single five-single six-single">
