...
<section class="customer-invoice ">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="invoice-innter" style="width: 940px;margin: 0 auto;background: #f9f9f9;overflow: hidden;padding: 30px;padding-top: 0;">
                    <table style="width:100%">
                        <tr>
                            ...
                            <td  style="width:60%;float: left;">
                                ...
                                <div class="invoice-bar" style="background:#fff; transform: skew(36deg); width: 80%; margin-left: 182px; padding: 12px 32px; margin-top: 6px;"> 
                                    <p style="transform: skew(-36deg);text-align: right;padding-right:45px;">Invoice :<strong>#{{$order->invoice_id}} </strong> -   Date: <strong>{{$order->created_at->format('d-m-y')}}</strong></span></p>
                                </div>
