                ...
                <div class="form-content">
                    ...
                    <form action="{{route('customer.order_track_result')}}"  data-parsley-validate="">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" id="invoice_id" class="form-control @error('invoice_id') is-invalid @enderror" name="invoice_id" value="{{ old('invoice_id') }}" placeholder="Enter Your Invoice ID" required>
                            @error('invoice_id')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
