        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('categories.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <!--        <input type="text" id="namespace" class="form-control @error('namespace') is-invalid @enderror" name="namespace" value="{{ $edit_data->namespace }}" id="namespace" required="">-->
                    <!--        @error('namespace')-->
                    <!--            <span class="invalid-feedback" role="alert">-->
                    <!--                <strong>{{ $message }}</strong>-->
                    <!--            </span>-->
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('categroy_video') is-invalid @enderror" name="categroy_video" value="{{ $edit_data->categroy_video}}" id="categroy_video" required="">
