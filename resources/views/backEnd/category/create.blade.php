    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('categories.store') }}" method="POST" class=row data-parsley-validate=""
                            ...
                            {{-- <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    <label for="namespace" class="form-label">Namespace (like men or women for avoid
                                        conflict between childcategories) *</label>
                                    <input type="text" id="namespace"
                                        class="form-control @error('namespace') is-invalid @enderror" name="namespace"
                                        value="{{ old('namespace') }}" id="namespace" required="">
                                    @error('namespace')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    <label for="categroy_video" class="form-label">Categroy Video *</label>
                                    <input type="text" class="form-control @error('categroy_video') is-invalid @enderror"
                                        name="categroy_video" value="{{ old('categroy_video') }}" id="categroy_video"
                                        required="">
                                    @error('categroy_video')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
