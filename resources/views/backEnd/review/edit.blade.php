...
<div class="container-fluid">
   ...
   <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form name="editForm" action="{{route('reviews.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control form-select select2 @error('ratting') is-invalid @enderror" name="ratting" value="{{ old('ratting') }}" id="ratting"  required>
                                    <option value="">Select..</option>
