                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            <label for="expense_cat_id" class="form-label">Category *</label>
                             <select class="form-control select2-multiple @error('expense_cat_id') is-invalid @enderror" id="expense_cat_id" name="expense_cat_id" value="{{ old('expense_cat_id') }}" data-toggle="select2"  data-placeholder="Choose ..."required>
                                <optgroup >
