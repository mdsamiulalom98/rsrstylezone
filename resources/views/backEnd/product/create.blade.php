                ...
                <div class="card-body">
                    <form action="{{route('products.store')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('youtube_link') is-invalid @enderror" name="youtube_link" value="{{ old('youtube_link') }}" id="youtube_link" />
                                @error('youtube_link')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-3">
                                ...
                                <select
                                    class="form-control select2-multiple @error('childcategory_id') is-invalid @enderror"
                                    id="childcategory_id"
                    ...
                    <div class="col-sm-4 mb-3">
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control @error('size_chart') is-invalid @enderror " name="size_chart"  value="{{ old('size_chart') }}"  id="size_chart">
                            @error('size_chart')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <!-- col end -->
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('sort') is-invalid @enderror" name="sort" value="{{ old('sort') }}" id="sort" />
                                @error('sort')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-sm-2">
                            <div class="form-check">
                                <label class="form-check-label d-block" for="topsale">Best Sell</label>
                                <label class="switch">
                                    <input type="checkbox" value="1" name="topsale" checked />
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <div class="form-check">
                                <label class="form-check-label d-block" for="feature_product">New Arrival </label>
                                <label class="switch">
                                    <input type="checkbox" value="1" name="feature_product" checked />
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
