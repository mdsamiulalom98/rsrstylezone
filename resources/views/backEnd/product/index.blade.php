        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    ...
                    <a href="{{route('products.topsalesort')}}" class="btn btn-info rounded-pill"><i class="fe-list"></i> Product Sorting</a>
                </div>
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{asset($value->size_chart)}}" class="backend-image" alt=""></td>
